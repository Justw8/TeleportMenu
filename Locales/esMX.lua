...
--L["Mogu'shan Palace"] = "MSP"
--L["Gate of the Setting Sun"] = "GoSS"
--L["Siege of Niuzao Temple"] = "SoNT"
...
--L["Reverse order of flyouts for mage abilities to make most recent expansion teleports appear first"] = "Reverse order of flyouts for mage abilities to make most recent expansion teleports appear first"

...
function tpm:CreateHerosPathFlyout(flyoutId, iconId, name)
	if db.showOnlySeasonalHerosPath and not (flyoutId == 1 or flyoutId == 8 or flyoutId == 11 or flyoutId == 12)then return end
